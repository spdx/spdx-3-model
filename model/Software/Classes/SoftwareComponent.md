...
A SoftwareComponent represents an abstract, conceptual software entity,
...
The primary purpose of a SoftwareComponent is to group multiple related
...
Since there might be relationships between SoftwareComponents
and between SoftwareComponents and Packages, values of different properties
might be different.
...
if they do not exist and the package is an instanceOf a SoftwareComponent,
then the properties of this SoftwareComponent are taken.
The chain may continue further to more SoftwareComponents,
as long as there are "parent" SoftwareComponents and no values have been specified.
