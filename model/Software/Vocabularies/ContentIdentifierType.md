...
- reqUID: the UID used by a requirements management or any other lifecycle management tool to uinquly identify a requirement item. UID, or unique ID, is a standard term in requirements engineering.
