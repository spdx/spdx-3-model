...
communication between an agent and external entities. Examples of widely
adopted agent protocols include: Model Context Protocol (MCP), Agent2Agent
(A2A), Agent Network Protocol (ANP), Agent Communication Protocol (AComP),
Agent Connect Protocol (AConP), Agent Interaction and Transaction Protocol
(AITP), Coral Protocol, and Agora.
