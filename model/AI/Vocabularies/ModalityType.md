...
List the different acceptable modalities of input or output used by the different FM-based components.

If the modality used by your component is not listed here, please select "other".
