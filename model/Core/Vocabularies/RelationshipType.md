...
- hasInput: The `from` Action, /AI/AIPackage, /Build/Build or DefinedProcess element has each `to` Element as an input.
...
- hasOutput: The `from` Action, /AI/AIPackage, /Build/Build or DefinedProcess element generates each `to` Element as an output.
