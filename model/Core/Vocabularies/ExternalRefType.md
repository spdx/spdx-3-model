...
- x509Cert: A reference to an X.509 certificate as defined in [RFC 5280](https://datatracker.ietf.org/doc/rfc5280/). The media type shall be `application/pkix-cert`.
