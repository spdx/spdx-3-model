...
- duns: [The Dun & Bradstreet D‑U‑N‑S Number is a unique nine-digit identifier for businesses](https://www.dnb.com/en-us/smb/duns.html)
...
- gln: [Global Location Number (GLN)](https://www.gs1.org/standards/id-keys/gln) can be used by companies to identify their locations
- glue: [GLobal Unique Enterprise (GLUE) Identifiers](https://datatracker.ietf.org/doc/draft-ietf-spice-glue-id/)
- gtin:  [Global Trade Item Number (GTIN)=](https://www.gs1.org/standards/id-keys/gtin) can be used to uniquely identify all of its trade items
- hsCodes: The Harmonized System (HS) of tariff nomenclature is an internationally standardized system of names and numbers to classify traded products defined by [World Customs Organization](https://www.wcoomd.org/en/topics/nomenclature/overview/what-is-the-harmonized-system.aspx)
